# CKEditor 5 editor generated configuration for the University of Maryland
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `hpq9mklmo384-xtf984ozeble`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
